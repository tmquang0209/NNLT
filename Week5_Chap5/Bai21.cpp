...
int main()
{
    double numberOfStockSales,
        ...
        profitPrice,
        total = 0;
    cout << "Nhap so luong co phan ban: ";
    numberOfStockSales = inputValidate(numberOfStockSales, 0);
    ...
    cout << endl
         << endl;
    (total > 0) ? cout << "Ban lai " << total : cout << "Ban lo " << -total;
    return 0;
}
